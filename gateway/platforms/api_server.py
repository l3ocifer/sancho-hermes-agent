...
class APIServerAdapter(BasePlatformAdapter):
    ...
    _UPDATE_ALLOWED_FIELDS = {"name", "schedule", "prompt", "deliver", "skills", "skill", "repeat", "enabled", "model"}
    ...
    async def _handle_create_job(self, request: "web.Request") -> "web.Response":
        ...
        try:
            ...
            # Per-job model pin (e.g. IaC cron-reconcile sets model from
            # hermes.toml); create_job accepts it natively.
            if body.get("model"):
