...
def _apply_env_overrides(config: GatewayConfig) -> None:
    ...
    # Homelab: also accept the bluebubbles-proxy pair (BLUEBUBBLES_PROXY_URL +
    # BLUEBUBBLES_API_KEY) as an enablement gate — see homelab/PATCHES.md.
    bluebubbles_server_url = getenv("BLUEBUBBLES_SERVER_URL")
    bluebubbles_password = getenv("BLUEBUBBLES_PASSWORD")
    bluebubbles_proxy_url = getenv("BLUEBUBBLES_PROXY_URL")
    bluebubbles_api_key = getenv("BLUEBUBBLES_API_KEY")
